...
export const fieldHelp = {
  ...
  staff: {
    name: 'El nombre completo del trabajador.',
    phone: 'Opcional. Para contactarlo.',
    email: 'Opcional. Correo del trabajador.',
    address: 'Opcional. Su domicilio.',
    curp: 'Opcional. Su CURP.',
    rfc: 'Opcional. Su RFC.',
    nss: 'Opcional. Su número de seguridad social (IMSS).',
    position: 'Su puesto, ej. "Cajero" o "Repartidor".',
    hireDate: 'La fecha en la que empezó a trabajar contigo — se usa para calcular su antigüedad y días de vacaciones sugeridos.',
    salary: 'Opcional. Su sueldo, tal como lo manejas con él.',
    payFrequency: 'Cada cuándo se le paga.',
    vacationOverride: 'Opcional. Si quieres darle un número de días distinto al que sugiere la ley, ponlo aquí — sobreescribe el cálculo automático.',
    emergencyContactName: 'Opcional. A quién contactar en caso de emergencia.',
    emergencyContactPhone: 'Opcional. Teléfono de esa persona.',
    photo: 'Opcional. Una foto del trabajador — se guarda de forma privada, no es pública.',
    notes: 'Opcional. Lo que te sea útil recordar de este trabajador.',
    linkedUser: 'Opcional. Si este trabajador también usa el sistema (por ejemplo, es cajero), vincula aquí su cuenta de acceso.',
  },
  schedules: {
    weekday: 'El día de la semana que cubre este horario.',
    startTime: 'A qué hora entra.',
    endTime: 'A qué hora sale.',
  },
  attendance: {
    status: 'Cómo se cuenta este día: asistió, faltó, llegó tarde, tuvo permiso o estuvo de vacaciones.',
    note: 'Opcional. Detalle del día, ej. motivo del permiso.',
  },
  loans: {
    amount: 'Cuánto le estás prestando al trabajador.',
    note: 'Opcional. Para qué es el préstamo.',
    deductionAmount: 'Cuánto le estás descontando ahora — puede ser un abono parcial.',
    deductionNote: 'Opcional. Ej. "Descuento de nómina semana 32".',
  },
  vacations: {
    startDate: 'Primer día de las vacaciones.',
    endDate: 'Último día de las vacaciones.',
    days: 'Cuántos días de vacaciones se le descuentan por este periodo.',
    note: 'Opcional.',
  },
  branches: {
