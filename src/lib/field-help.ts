...
export const fieldHelp = {
  ...
  products: {
    ...
    cost: 'Lo que te cuesta a ti conseguir o producir una unidad — se usa para calcular la utilidad. Se actualiza solo con cada compra a proveedor.',
    price: 'El precio al que se le vende al cliente. Si capturas un margen, se calcula solo a partir del costo.',
    marginPercent: 'Cuánto quieres ganar sobre el costo, en porcentaje. Al capturarlo, el precio se calcula solo — y se recalcula cada vez que el costo cambie por una nueva compra.',
    initialStock: 'Cuánto tienes en existencia ahora mismo, en la unidad de este producto. Se descuenta solo con cada venta y se puede ajustar después desde Inventario.',
  ...
  branches: {
    name: 'El nombre con el que vas a identificar esta sucursal, ej. "Sucursal Centro".',
    address: 'Opcional. La dirección de esta sucursal.',
  },
  transfers: {
    fromBranch: 'De dónde sale la mercancía.',
    toBranch: 'A dónde llega la mercancía.',
    product: 'Qué producto estás traspasando.',
    quantity: 'Cuánto estás traspasando de este producto.',
  },
  suppliers: {
